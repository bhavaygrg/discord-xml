...
var Server = function (_getAccount, _getHealth, _getContractData, _getLedgerEntries, _getTransaction, _getEvents, _getNetwork, _getLatestLedger, _simulateTransaction, _prepareTransaction, _sendTransaction, _requestAirdrop) {
  ...
  _createClass(Server, [{
    ...
    value: function getAccount(_x) {
      return (_getAccount = _getAccount || _asyncToGenerator(_regeneratorRuntime().mark(function _callee(address) {
        var _resp$entries;
        var ledgerKey, resp, entries, ledgerEntryData, accountEntry;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              resp = _context.sent;
              entries = (_resp$entries = resp.entries) !== null && _resp$entries !== void 0 ? _resp$entries : [];
              if (!(entries.length === 0)) {
                _context.next = 7;
                break;
              }
    ...
    value: function getHealth() {
      return (_getHealth = _getHealth || _asyncToGenerator(_regeneratorRuntime().mark(function _callee2() {
    ...
    key: "getContractData",
    value: function getContractData(_x2, _x3) {
      return (_getContractData = _getContractData || _asyncToGenerator(_regeneratorRuntime().mark(function _callee3(contract, key) {
        var durability,
          scAddress,
          xdrDurability,
          contractKey,
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 22:
              ...
              return _context3.abrupt("return", this.getLedgerEntries(contractKey).then(function (response) {
                var _response$entries;
                var entries = (_response$entries = response.entries) !== null && _response$entries !== void 0 ? _response$entries : [];
                if (entries.length === 0) {
    ...
    value: function getLedgerEntries() {
      return (_getLedgerEntries = _getLedgerEntries || _asyncToGenerator(_regeneratorRuntime().mark(function _callee4() {
        var _len,
          keys,
          _key,
          _args4 = arguments;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              for (_len = _args4.length, keys = new Array(_len), _key = 0; _key < _len; _key++) {
                keys[_key] = _args4[_key];
              }
              _context4.next = 3;
    ...
    key: "getTransaction",
    value: function getTransaction(_x4) {
      return (_getTransaction = _getTransaction || _asyncToGenerator(_regeneratorRuntime().mark(function _callee5(hash) {
        var raw, successInfo, _meta$v3$sorobanMeta, meta, result;
          ...
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              if (raw.status === _soroban_rpc.SorobanRpc.GetTransactionStatus.SUCCESS) {
                meta = _stellarBase.xdr.TransactionMeta.fromXDR(raw.resultMetaXdr, "base64");
    ...
    key: "getEvents",
    value: function getEvents(_x5) {
      return (_getEvents = _getEvents || _asyncToGenerator(_regeneratorRuntime().mark(function _callee6(request) {
        var _request$filters;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              return _context6.abrupt("return", jsonrpc.postObject(this.serverURL.toString(), "getEvents", _objectSpread({
    ...
    value: function getNetwork() {
      return (_getNetwork = _getNetwork || _asyncToGenerator(_regeneratorRuntime().mark(function _callee7() {
    ...
    key: "getLatestLedger",
    value: function getLatestLedger() {
      return (_getLatestLedger = _getLatestLedger || _asyncToGenerator(_regeneratorRuntime().mark(function _callee8() {
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              return _context8.abrupt("return", jsonrpc.post(this.serverURL.toString(), "getLatestLedger"));
            case 1:
            case "end":
    ...
    value: function simulateTransaction(_x6) {
      return (_simulateTransaction = _simulateTransaction || _asyncToGenerator(_regeneratorRuntime().mark(function _callee9(transaction) {
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              return _context9.abrupt("return", jsonrpc.post(this.serverURL.toString(), "simulateTransaction", transaction.toXDR()).then(_transaction.parseRawSimulation));
            case 1:
            case "end":
    ...
    value: function prepareTransaction(_x7, _x8) {
      return (_prepareTransaction = _prepareTransaction || _asyncToGenerator(_regeneratorRuntime().mark(function _callee10(transaction, networkPassphrase) {
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 10:
              return _context10.abrupt("return", (0, _transaction.assembleTransaction)(transaction, passphrase, simResponse).build());
            case 11:
            case "end":
    ...
    key: "sendTransaction",
    value: function sendTransaction(_x9) {
      return (_sendTransaction = _sendTransaction || _asyncToGenerator(_regeneratorRuntime().mark(function _callee11(transaction) {
    ...
    key: "requestAirdrop",
    value: function requestAirdrop(_x10, _x11) {
      return (_requestAirdrop = _requestAirdrop || _asyncToGenerator(_regeneratorRuntime().mark(function _callee12(address, friendbotUrl) {
