...
function post(_x, _x2) {
  return (_post = _post || _asyncToGenerator(_regeneratorRuntime().mark(function _callee(url, method) {
    var _len,
      params,
      _key,
      response,
...
function postObject(_x3, _x4, _x5) {
  return (_postObject = _postObject || _asyncToGenerator(_regeneratorRuntime().mark(function _callee2(url, method, param) {
